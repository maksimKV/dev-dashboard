...
var init_app = __esm({
  "angular:jit:template:src\\app\\app.html"() {
    app_default = `<mat-sidenav-container [class.sidenav-right]="sidebarPosition === 'right'" style="height: 100vh;">\r
  <mat-sidenav #sidenav [mode]="sidenavMode" [opened]="sidenavOpened" (closedStart)="sidenavOpened = false">\r
    <mat-nav-list>\r
      <a mat-list-item routerLink="/dashboard" routerLinkActive="active" *ngIf="enabledFeatures.dashboard" (click)="isMobile ? sidenavOpened = false : null">Dashboard</a>\r
      <a mat-list-item routerLink="/tasks" routerLinkActive="active" *ngIf="enabledFeatures.tasks" (click)="isMobile ? sidenavOpened = false : null">Tasks</a>\r
      <a mat-list-item routerLink="/notes" routerLinkActive="active" *ngIf="enabledFeatures.notes" (click)="isMobile ? sidenavOpened = false : null">Notes</a>\r
      <a mat-list-item routerLink="/timer" routerLinkActive="active" *ngIf="enabledFeatures.timer" (click)="isMobile ? sidenavOpened = false : null">Focus Timer</a>\r
      <a mat-list-item routerLink="/snippets" routerLinkActive="active" *ngIf="enabledFeatures.snippets" (click)="isMobile ? sidenavOpened = false : null">Snippets</a>\r
      <a mat-list-item routerLink="/stats" routerLinkActive="active" *ngIf="enabledFeatures.stats" (click)="isMobile ? sidenavOpened = false : null">Stats</a>\r
      <a mat-list-item routerLink="/settings" routerLinkActive="active" *ngIf="enabledFeatures.settings" (click)="isMobile ? sidenavOpened = false : null">Settings</a>\r
    </mat-nav-list>\r
  </mat-sidenav>\r
  <mat-sidenav-content style="padding: 24px;">\r
    <mat-toolbar color="primary" *ngIf="isMobile" style="position: sticky; top: 0; z-index: 1001;">\r
      <button mat-icon-button (click)="toggleSidenav()">\r
        <mat-icon>menu</mat-icon>\r
      </button>\r
      <span style="margin-left: 1rem; font-weight: 500;">Dev Dashboard</span>\r
    </mat-toolbar>\r
...
var init_app2 = __esm({
  "angular:jit:style:src\\app\\app.scss"() {
    app_default2 = "/* src/app/app.scss */\n.high-contrast {\n  background: #000 !important;\n  color: #fff !important;\n}\n.high-contrast .mat-card,\n.high-contrast .mat-sidenav,\n.high-contrast .mat-sidenav-content,\n.high-contrast .mat-list-item,\n.high-contrast .mat-toolbar,\n.high-contrast .mat-form-field,\n.high-contrast .mat-slide-toggle,\n.high-contrast .mat-raised-button {\n  background: #111 !important;\n  color: #fff !important;\n  border-color: #fff !important;\n}\n.high-contrast a,\n.high-contrast a:visited {\n  color: #ff0 !important;\n  text-decoration: underline;\n}\n.high-contrast .mat-raised-button.mat-primary {\n  background: #fff !important;\n  color: #000 !important;\n}\n.high-contrast .mat-slide-toggle-thumb {\n  background: #fff !important;\n}\n.high-contrast .mat-slide-toggle-bar {\n  background: #444 !important;\n}\n.high-contrast .mat-form-field-underline {\n  background: #fff !important;\n}\n.high-contrast .mat-form-field-label {\n  color: #ff0 !important;\n}\n.high-contrast *:focus {\n  outline: 3px solid #ff0 !important;\n  outline-offset: 2px;\n}\n@media (max-width: 900px) {\n  mat-sidenav-container {\n    flex-direction: column !important;\n  }\n  mat-sidenav {\n    min-width: 60px !important;\n    max-width: 180px !important;\n    width: 60vw !important;\n  }\n  mat-sidenav-content {\n    padding: 12px !important;\n  }\n  .settings-section,\n  .stats-dashboard,\n  .mat-card {\n    padding: 1rem !important;\n    margin-bottom: 1rem !important;\n  }\n}\n@media (max-width: 600px) {\n  mat-sidenav {\n    position: absolute !important;\n    width: 100vw !important;\n    min-width: 0 !important;\n    max-width: 100vw !important;\n    z-index: 1000;\n  }\n  mat-sidenav-content {\n    padding: 6px !important;\n  }\n  h1,\n  h2,\n  h3 {\n    font-size: 1.2rem !important;\n  }\n  .settings-section,\n  .stats-dashboard,\n  .mat-card {\n    padding: 0.5rem !important;\n    margin-bottom: 0.5rem !important;\n  }\n  .stat-card,\n  .mat-card {\n    font-size: 0.95rem !important;\n  }\n  .feature-toggles,\n  .stats-cards {\n    flex-direction: column !important;\n    gap: 0.5rem !important;\n  }\n}\n.sidenav-right mat-sidenav {\n  left: auto !important;\n  right: 0 !important;\n  border-right: none !important;\n  border-left: 1px solid #e0e0e0 !important;\n}\n.sidenav-right mat-sidenav-content {\n  margin-left: 0 !important;\n  margin-right: 0 !important;\n}\n/*# sourceMappingURL=app.css.map */\n";
  }
});
...
var init_app3 = __esm({
  "src/app/app.ts"() {
    ...
    App = class App2 {
      ...
      sidenav;
      constructor(platformId, breakpointObserver, cdr) {
      ...
      loadEnabledFeatures() {
        ...
        if (features) {
          try {
            ...
            this.enabledFeatures = __spreadValues(__spreadValues({}, this.enabledFeatures), parsed);
          } catch (e) {
