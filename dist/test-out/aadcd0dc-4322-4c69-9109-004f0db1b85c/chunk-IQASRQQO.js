...
var init_marked_esm = __esm({
  "node_modules/marked/lib/marked.esm.js"() {
    ...
    blockGfm = __spreadProps(__spreadValues({}, blockNormal), {
      lheading: lheadingGfm,
      table: gfmTable,
      paragraph: edit(_paragraph).replace("hr", hr).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", gfmTable).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", _tag).getRegex()
    });
    blockPedantic = __spreadProps(__spreadValues({}, blockNormal), {
      html: edit(
        `^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`
    ...
    inlinePedantic = __spreadProps(__spreadValues({}, inlineNormal), {
      link: edit(/^!?\[(label)\]\((.*?)\)/).replace("label", _inlineLabel).getRegex(),
      reflink: edit(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", _inlineLabel).getRegex()
    });
    inlineGfm = __spreadProps(__spreadValues({}, inlineNormal), {
    ...
    inlineBreaks = __spreadProps(__spreadValues({}, inlineGfm), {
...
var BUTTON_TEXT_COPY, BUTTON_TEXT_COPIED, _ClipboardButtonComponent, ClipboardButtonComponent, CLIPBOARD_OPTIONS, _LanguagePipe, LanguagePipe, PrismPlugin, MARKED_EXTENSIONS, MARKED_OPTIONS, MERMAID_OPTIONS, errorJoyPixelsNotLoaded, errorKatexNotLoaded, errorMermaidNotLoaded, errorClipboardNotLoaded, errorClipboardViewContainerRequired, errorSrcWithoutHttpClient, SECURITY_CONTEXT, _MarkdownService, MarkdownService, _MarkdownComponent, MarkdownComponent, _MarkdownPipe, MarkdownPipe, sharedDeclarations, _MarkdownModule, MarkdownModule;
var init_ngx_markdown = __esm({
  "node_modules/ngx-markdown/fesm2022/ngx-markdown.mjs"() {
    "use strict";
    init_core();
    init_core();
    ...
    _ClipboardButtonComponent = class _ClipboardButtonComponent {
      constructor() {
  ...
  `, isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    ClipboardButtonComponent = _ClipboardButtonComponent;
  ...
  `,
    ...
    CLIPBOARD_OPTIONS = new InjectionToken("CLIPBOARD_OPTIONS");
    _LanguagePipe = class _LanguagePipe {
    ...
    MARKED_EXTENSIONS = new InjectionToken("MARKED_EXTENSIONS");
    MARKED_OPTIONS = new InjectionToken("MARKED_OPTIONS");
    MERMAID_OPTIONS = new InjectionToken("MERMAID_OPTIONS");
    errorJoyPixelsNotLoaded = "[ngx-markdown] When using the `emoji` attribute you *have to* include Emoji-Toolkit files to `angular.json` or use imports. See README for more information";
    errorKatexNotLoaded = "[ngx-markdown] When using the `katex` attribute you *have to* include KaTeX files to `angular.json` or use imports. See README for more information";
    errorMermaidNotLoaded = "[ngx-markdown] When using the `mermaid` attribute you *have to* include Mermaid files to `angular.json` or use imports. See README for more information";
    errorClipboardNotLoaded = "[ngx-markdown] When using the `clipboard` attribute you *have to* include Clipboard files to `angular.json` or use imports. See README for more information";
    errorClipboardViewContainerRequired = "[ngx-markdown] When using the `clipboard` attribute you *have to* provide the `viewContainerRef` parameter to `MarkdownService.render()` function";
    errorSrcWithoutHttpClient = "[ngx-markdown] When using the `src` attribute you *have to* pass the `HttpClient` as a parameter of the `forRoot` method. See README for more information";
    SECURITY_CONTEXT = new InjectionToken("SECURITY_CONTEXT");
    _MarkdownService = class _MarkdownService {
      get options() {
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: MarkdownService, decorators: [{
      ...
      type: Inject,
      args: [PLATFORM_ID]
    }] }, { type: SecurityContext, decorators: [{
      type: Inject,
      args: [SECURITY_CONTEXT]
    }] }, { type: HttpClient, decorators: [{
      type: Optional
    }] }, { type: DomSanitizer }] });
    _MarkdownComponent = class _MarkdownComponent {
    ...
    MarkdownComponent = _MarkdownComponent;
    ...
    _MarkdownPipe = class _MarkdownPipe {
    ...
    _MarkdownModule = class _MarkdownModule {
    ...
    MarkdownModule = _MarkdownModule;
...
@angular/core/fesm2022/rxjs-interop.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-IQASRQQO.js.map
